...
#include "AirCraftAIController.h"
...
void AAirCraftAIController::BeginPlay()
{
	...
	GetWorld()->GetTimerManager().SetTimer(
		DelayTimerHandle,
		this,
		&AAirCraftAIController::StartMove,
		3.0f,
		false);
...
void AAirCraftAIController::Tick(float DeltaSeconds)
{
	Super::Tick(DeltaSeconds);

	switch (m_modelAIState)
	{
	case EAircraftAIState::IDLE:
		break;
	case EAircraftAIState::GENARATE_SPLINE:
		//
		break;
	case EAircraftAIState::MOVE:
		Move(DeltaSeconds);
		break;
...
void AAirCraftAIController::StartMove()
{
	...
	m_modelAIState = EAircraftAIState::MOVE;
	m_elapsedTimeChange = 0.0f;
	
}

void AAirCraftAIController::StartMove2()
{
...
void AAirCraftAIController::Move(float DeltaSeconds)
{
